...
class DatabaseLoaderRead(DatabaseLoader):
    def __init__(self, sql, params: dict, rows: int = 10_000_000, batch_size: int = 100_000):
        self.sql = sql
...
class DatabaseLoaderWrite(DatabaseLoader):
    def __init__(self, file_name, table_name, params: dict, rows: int = 10_000_000, batch_size: int = 100_000):
